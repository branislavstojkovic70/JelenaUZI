...
def execute_xpath_etree(element, xpath, print = True):
...
if __name__ == "__main__":
    ...
    tree = ET.parse('data/upiti.xml')
    lista = execute_xpath_etree(tree, '//Upit', False)
    

    for elem in lista:
        execute_xpath_db(exist_db, 'books.xml', 'Books', elem.text)
